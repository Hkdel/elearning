        ...
        <div class="left" id="a">
        	<div class="left-top" >
				...
				<input type="hidden" name="id" value="${note.id }"/>
            		<input class="inp radius_box" type="text" style="color:#aaa;width: 180px;margin-left: 200px;" placeholder="           手记名" name="name"  value="${note.name}" /><br />
            		<p style="color: #808080;margin-left: 510px;">${note.createTime }</p>
            		...
            		<textarea class="text radius_box" style="color:#aaaaaa;resize: none;" placeholder="请输入手记正文" name="content">${note.content }</textarea>
           			<a href="study/frontStudy?method=noteList">
						<input type="button" value="返&nbsp;&nbsp;回" class="radius_box" 
						 style="color:#FFF;width:100px;height:30px;background-color:#65a2fd;margin-left: 500px;margin-top: 20px;"/>
					</a>
