...
<body>
	<form action="admin/system/role?method=add" method="post" id="submitForm">
	...
	<table class="query_form_table">
		<tr>
			<th>角色名称</th>
			<td><input type="text" name="roleName" /><span class="red_star">*</span>${error }</td>
			<th>创建人</th>
		...
		<tr>
			<th>创建时间</th>
			<td><input type="text" name="nowTime" value="${createTime }" readonly /></td>
			<th></th>
			<td></td>
		</tr>
	</table>
